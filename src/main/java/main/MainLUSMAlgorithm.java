...
//        String input1="example.txt";
        String input1="SIGN_sequence_utility_short20.txt";
...
//        String output = ".//outputNew_improve_kosrak10k.txt";
        ...
        System.out.println("Memory before execution: " + initialMemory/(1024*1024) + " MB");
...
//                System.gc();
        ...
        buffer.append("Memory at program end: " + finalMemory/(1024*1024) + " MB\n");
        buffer.append("Total memory consumed: " + (finalMemory-initialMemory)/(1024*1024) + " MB\n");
        buffer.append("Peak memory usage: " + MemoryLogger.getInstance().getMaxMemory() + " MB\n");
        buffer.append("输出maxutility:"+max_utility[0]);
        writer.write(buffer.toString());
        writer.newLine();
        System.out.println("Memory at program end: " + finalMemory/(1024*1024) + " MB");
        long memoryConsumed=finalMemory-initialMemory;
        System.out.println("Total memory consumed: " + memoryConsumed/(1024*1024) + " MB");
        System.out.println("Peak memory usage: " + MemoryLogger.getInstance().getMaxMemory() + " MB");
        writer.close();
