...
//        if (!hasProcessedSequenceList.contains(sequence) && hasKnownHighUtilitySequence.contains(sequence) == false) {
            System.out.println("Low utility sequence: " + sequence);
            StringBuilder buffer = new StringBuilder();
            buffer.append("Low utility sequence: " + sequence).append("\n");
            writer.write(buffer.toString());
            writer.newLine();
...
public void printLowUtilitySequence() throws IOException {
    ...
    public void showStates() throws IOException {
        ...
        buffer.append("Number of utility computations: " + countOfCountUtilities).append("\n");
        buffer.append("Data loading time: " + (double) runtime2 / 1000 + " s").append("\n");
        buffer.append("Bitmap construction time: " + (double) runtime4 / 1000 + " s").append("\n");
        buffer.append("Max sequence generation time: " + (double) runtime5 / 1000 + " s").append("\n");
        buffer.append("Preprocessing time: " + (double) runtime3 / 1000 + " s").append("\n");
        buffer.append("Total execution time: " + (double) runtime / 1000 + " s").append("\n");
        buffer.append("Memory used during execution: " + MemoryLogger.getInstance().getMaxMemory() + " MB").append("\n");
        buffer.append("Total system memory: " + (double) Runtime.getRuntime().totalMemory() / 1024d / 1024d + " MB").append("\n");
        buffer.append("Free memory: " + (double) Runtime.getRuntime().freeMemory() / 1024d / 1024d + " MB").append("\n");
        buffer.append("Number of candidates (optimized): " + candidatesCount).append("\n");
        buffer.append("Number of patterns: " + patternCount).append("\n");

        writer.write(buffer.toString());
        writer.newLine();

        System.out.println("Number of utility computations: " + countOfCountUtilities);
        System.out.println("Data loading time: " + (double) runtime2 / 1000 + " s");
        System.out.println("Bitmap construction time: " + (double) runtime4 / 1000 + " s");
        System.out.println("Max sequence generation time: " + (double) runtime5 / 1000 + " s");
        System.out.println("Preprocessing time: " + (double) runtime3 / 1000 + " s");
        System.out.println("Total execution time: " + (double) runtime / 1000 + " s");
        System.out.println("Memory used during execution: " + MemoryLogger.getInstance().getMaxMemory() + " MB");
        System.out.println("Total system memory: " + (double) Runtime.getRuntime().totalMemory() / 1024d / 1024d + " MB");
        System.out.println("Free memory: " + (double) Runtime.getRuntime().freeMemory() / 1024d / 1024d + " MB");
        System.out.println("Number of candidates: " + candidatesCount);
        System.out.println("Number of patterns: " + patternCount);
    }
